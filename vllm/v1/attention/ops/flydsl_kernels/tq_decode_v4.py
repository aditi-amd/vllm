...
def build_tq_decode_v4_module(
    ...
    def tq_decode_v4_kernel(
        ...
        # QG=16 → 4096 B, 256 chunks, 4 iters. QG=8 → 2048 B, 128 chunks, 2 iters.
        # For QG=8 the LDS rows 8..15 stay untouched (the MFMA computes garbage
        # there but those rows are gated out of global-memory writes below).
