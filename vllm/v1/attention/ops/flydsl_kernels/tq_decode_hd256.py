...
def build_tq_decode_hd256_module(
    num_seqs: int,
    num_kv_heads: int,
    num_partitions: int,
    ...
    # The K-tile loop walks ``_BS // TILE_SIZE`` tiles per block, so any
    # multiple of TILE_SIZE that also evenly tiles KV_COMPUTE_BLOCK works.
    ...
    # distributed WARP_SIZE per iteration. For HEAD_SIZE=256 (Q_GROUPS_PER_ROW
    # = 32) this is QG // 2 (4 for QG=8, 8 for QG=16).
    QG_LOAD_ITERS = QG * Q_GROUPS_PER_ROW // WARP_SIZE
